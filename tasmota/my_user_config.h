...
#define WIFI_DNS               "192.168.2.254"     // [IpAddress4] If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)

#define STA_SSID1              "Buschfunk"                // [Ssid1] Wifi SSID
#define STA_PASS1              "xxx"                // [Password1] Wifi password
#define STA_SSID2              ""                // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              ""                // [Password2] Optional alternate AP Wifi password
#define WIFI_CONFIG_TOOL       WIFI_SERIAL         // [WifiConfig] Default tool if wifi fails to connect
...
#define MQTT_HOST              "cloudhost.local"                // [MqttHost]
#define MQTT_FINGERPRINT1      "CE EC 89 FE 36 24 94 99 54 7C 15 6C 33 46 29 54 2F B0 90 60"  // [MqttFingerprint1]
#define MQTT_FINGERPRINT2      "A5 02 FF 13 99 9F 8B 39 8E F1 83 4F 11 23 65 0B 32 36 FC 07"  // [MqttFingerprint2]
#define MQTT_PORT              8883              // [MqttPort] MQTT port (10123 on CloudMQTT)
#define MQTT_USER              "sonoff_xxx"       // [MqttUser] MQTT user
#define MQTT_PASS              "sonoff_xxx"       // [MqttPassword] MQTT password
