...
#define MQTT_USER              "sonoff_755A36"       // [MqttUser] MQTT user
#define MQTT_PASS              "PASS_755A36"       // [MqttPassword] MQTT password
...
#define WEB_PASSWORD           "PASS_755A36"        // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
#define FRIENDLY_NAME          "sonoff_755A36"   // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
