...
#define MQTT_HOST              "rauschhost.my.home"                // [MqttHost]
...
#define MQTT_USER              "sonoff_522FC1"       // [MqttUser] MQTT user
#define MQTT_PASS              "PASS_522FC1"       // [MqttPassword] MQTT password
...
#define WEB_PASSWORD           "PASS_522FC1"        // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
#define FRIENDLY_NAME          "sonoff_522FC1"   // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
