...
#define MQTT_USER              "sonoff_755F13"       // [MqttUser] MQTT user
#define MQTT_PASS              "PASS_755F13"       // [MqttPassword] MQTT password
...
#define WEB_PASSWORD           "PASS_755F13"        // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
#define FRIENDLY_NAME          "sonoff_755F13"   // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
