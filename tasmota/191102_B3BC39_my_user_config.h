...
#define WIFI_DNS               "192.168.2.61"     // [IpAddress4] If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)

#define STA_SSID1              "Things"                // [Ssid1] Wifi SSID
#define STA_PASS1              "PASS_WIFI"                // [Password1] Wifi password
...
// -- Syslog --------------------------------------
#define SYS_LOG_HOST           "192.168.2.5"                // [LogHost] (Linux) syslog host
...
#define MQTT_LOG_LEVEL         LOG_LEVEL_INFO    // [MqttLog] (LOG_LEVEL_NONE, LOG_LEVEL_ERROR, LOG_LEVEL_INFO, LOG_LEVEL_DEBUG, LOG_LEVEL_DEBUG_MORE)
...
#define MQTT_HOST              "cloudhost.my.home"                // [MqttHost]
...
#define MQTT_USER              "sonoff_B3BC39"       // [MqttUser] MQTT user
#define MQTT_PASS              "PASS_B3BC39"       // [MqttPassword] MQTT password
...
#define MQTT_FULLTOPIC         "env/%prefix%/%topic%/" // [FullTopic] Subscribe and Publish full topic name - Legacy topic
...
#define MQTT_TOPIC             PROJECT "_%06X"   // [Topic] (unique) MQTT device topic, set to 'PROJECT "_%06X"' for unique topic including device MAC address
...
#define WEB_PASSWORD           "PASS_B3BC39"        // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
#define FRIENDLY_NAME          "sonoff_B3BC39"   // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
